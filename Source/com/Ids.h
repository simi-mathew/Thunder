...
namespace RPC {
    ...
    enum IDS {
        ...
        ID_CONTROLLER_NOTIFICATION      = (ID_OFFSET_INTERNAL + 0x0008),
        ID_CONTROLLER_CALLSTACK_DATA_ITERATOR = (ID_OFFSET_INTERNAL + 0x0009),
        ID_CONTROLLER_SUBSYSTEMS_PARAMS_DATA_ITERATOR = (ID_OFFSET_INTERNAL + 0x000A),
        ID_CONTROLLER_META_DATA_SERVICE_ITERATOR = (ID_OFFSET_INTERNAL + 0x000B),
        ID_CONTROLLER_META_DATA_CHANNEL_ITERATOR = (ID_OFFSET_INTERNAL + 0x000C),
        ID_CONTROLLER_META_DATA_BRIDGE_ITERATOR = (ID_OFFSET_INTERNAL + 0x000D),
